...
class ActorCritic(nn.Module):
    ...
    def __call__(self, x):
        ...
        actor_logtstd = self.param('log_std', nn.initializers.zeros, (self.action_dim,))    # this seems specific to mabrax!
        pi = distrax.MultivariateNormalDiag(actor_mean, jnp.exp(actor_logtstd)) # slightly diff normalisation to in other programs!
